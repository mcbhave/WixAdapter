...
namespace WixAdapter.Controllers
{
    ...
    public class SchemasController : ControllerBase
    {
        ...
        public SchemasController(WixServices wixServices)
        {
        ...
        public string Index()
        {
            ...
            //_wixServices.SetMessage(new Message() { Callerid = "Wix", Callerrequest = "", Callresponse = "", Callerrequesttype = "", Callertype = "Wix Index", Messageype = "", MessageDesc = "" });
        ...
        public IActionResult find(WixDB.find id)
        {
            ...
            try
            {
                ...
                {
                    List<WixCaseType> oct = _wixServices.Searchcasetypes(o, false);
            ...
            {
                _wixServices.SetMessage(new Message() { Callerid = "Wix", Callerrequest = srequest, Callresponse = sresponse, Callerrequesttype = scasetypes, Callertype = "Wix Find", Messageype = "ERROR", MessageDesc = smessage + " " + ex.ToString() });

                throw;
            }
            finally
            {
                _wixServices.SetMessage(new Message() { Callerid = "Wix", Callerrequest = srequest, Callresponse = sresponse, Callerrequesttype = scasetypes, Callertype = "Wix Find", MessageDesc = smessage });
            }
        ...
        public IActionResult list(WixDB.find id)
        {
            ...
            try
            {
                ...
                //get all case types
                List<WixCaseType> oct = _wixServices.Searchcasetypes("all", false);

                foreach (WixCaseType o in oct)
                {
            ...
            {
                _wixServices.SetMessage(new Message() { Callerid = "Wix", Callerrequest = srequest, Callresponse = sresponse, Callerrequesttype = "list", Callertype = "Wix list", Messageype = "ERROR", MessageDesc = smessage + " " + ex.ToString(),  });

                throw;
            }
            finally
            {
                _wixServices.SetMessage(new Message() { Callerid = "Wix", Callerrequest = srequest, Callresponse = sresponse, Callerrequesttype = "list", Callertype = "Wix list", MessageDesc = smessage,  });
            }
        ...
        private static WixDB.Schema GetSchema(WixCaseType casetype, int maxPage, int ttl)
        {
            WixDB.Schema osch = new WixDB.Schema
            {
            ...
            {
                foreach (WixCasetypefield f in casetype.Fields)
                {
